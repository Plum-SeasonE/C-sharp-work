...
namespace CrawlerForm {
  class Crawler {
    ...
    private ConcurrentDictionary<string, bool> done = new ConcurrentDictionary<string, bool>();
    ...
    public ConcurrentDictionary<string, bool> DownloadedPages { get => done; } //已下载网页
    ...
    public void Start() {
      ...
      ThreadPool.SetMaxThreads(2, 2);
            ...
            bool f = true;
            object obj = f as object;
            while (f) {
                ThreadPool.QueueUserWorkItem(new WaitCallback(fun),obj);
      }
      CrawlerStopped(this);
    }
